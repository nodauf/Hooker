...
namespace SylantStrikeInject {
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                {"p=|process=", "Process name to protect with MyEDR", v => { processList.Add(v.ToLower()); }},
            ...
            try
            {
                ...
                BasicInject.SetErrorMode(BasicInject.ErrorModes.SEM_FAILCRITICALERRORS);
                /* IntPtr pDll = BasicInject.LoadLibrary(dllPath);
                 if (pDll == IntPtr.Zero)
                 {
